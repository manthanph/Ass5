...
Description:-
The Healthcare Insurance Portal is a simple web application built using Node.js, Express.js, and MongoDB that allows users to explore and manage health insurance policies online.
This project demonstrates a basic implementation of a real-world insurance system where users can register, log in, view available policies, and purchase insurance plans. It also includes administrative functionality to manage policies.
